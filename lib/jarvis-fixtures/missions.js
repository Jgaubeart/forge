// Fixture missions that demonstrate the whole Mission Bay surface.
//
...
// an optional team, a chronological event feed (viewer emit() shape: ts, agent,
// kind, label), an optional staged approval, and a structured result.
//
// These are UI fixtures. Nothing here executed anything, and the approval
// fixtures are marked so the interface never implies a real action.
...
export const FIXTURE_MISSIONS = [
  {
    id: "m-fleet-1",
    kind: { key: "fleet", icon: "⚔️", name: "THE FLEET" },
    ...
    team: [
      { name: "SCOUT", role: "recon", state: "active" },
      { name: "FORGE", role: "maker", state: "queued" },
      { name: "SAGE", role: "critic", state: "pending" },
    ],
    events: [
      { ts: t(0), agent: "JARVIS", kind: "spawn", label: "Mission accepted" },
      { ts: t(1), agent: "SCOUT", kind: "spawn", label: "Researching the landscape" },
      { ts: t(2), agent: "SCOUT", kind: "tool", label: "searching the web…" },
      { ts: t(4), agent: "SCOUT", kind: "tool", label: "source inspected — competitor pricing" },
      { ts: t(6), agent: "FORGE", kind: "stage", label: "Draft queued" },
      { ts: t(7), agent: "JARVIS", kind: "tool", label: "delegating a sub-task…" },
    ],
    approval: null,
    result: null,
    cancelable: true,
  ...
  {
    id: "m-approval-1",
    kind: { key: "announce", icon: "📣", name: "ANNOUNCE-IT-EVERYWHERE" },
    ...
    team: [],
    events: [
      { ts: t(10), agent: "HERALD", kind: "spawn", label: "Drafting announcements" },
      { ts: t(12), agent: "HERALD", kind: "done", label: "5 drafts ready" },
      { ts: t(13), agent: "JARVIS", kind: "tool", label: "waiting for confirmation" },
    ],
    approval: {
      id: "ap-announce",
  ...
  },
  {
    ...
    team: [
      { name: "SCOUT", role: "recon", state: "done" },
      { name: "FORGE", role: "maker", state: "done" },
      { name: "SAGE", role: "critic", state: "done" },
    ],
    events: [
      { ts: t(20), agent: "JARVIS", kind: "spawn", label: "Mission accepted" },
      { ts: t(21), agent: "SCOUT", kind: "done", label: "Recon memo ready" },
      { ts: t(24), agent: "FORGE", kind: "done", label: "Draft ready" },
      { ts: t(27), agent: "SAGE", kind: "done", label: "Critique and next actions ready" },
      { ts: t(28), agent: "JARVIS", kind: "done", label: "mission complete" },
    ],
    approval: null,
    result: {
      kind: "fleet",
  ...
  {
    id: "m-failed-1",
    kind: { key: "warroom", icon: "📊", name: "CHANNEL WAR ROOM" },
    ...
    team: [],
    events: [
      { ts: t(30), agent: "WARROOM", kind: "spawn", label: "Assembling the war room" },
      { ts: t(31), agent: "WARROOM", kind: "tool", label: "pulling performance numbers…" },
      {
        ts: t(32),
        agent: "WARROOM",
        kind: "error",
        label: "analytics connection is not available",
      },
      { ts: t(32), agent: "JARVIS", kind: "error", label: "mission stopped — nothing was reported" },
    ],
    approval: null,
    result: null,
  ...
  {
    id: "m-cancelled-1",
    kind: { key: "reaper", icon: "💰", name: "SUBSCRIPTION REAPER" },
    ...
    team: [],
    events: [
      { ts: t(40), agent: "REAPER", kind: "spawn", label: "Sweeping recurring charges" },
      { ts: t(41), agent: "JARVIS", kind: "error", label: "mission cancelled — no drafts written" },
    ],
    approval: null,
    result: null,
    cancelable: false,
  ...
  {
    id: "m-single-1",
    kind: { key: "buildapp", icon: "🛠️", name: "BUILD-ME-AN-APP" },
    ...
    team: [],
    events: [
      { ts: t(50), agent: "FORGE", kind: "spawn", label: "Opening the workshop" },
      { ts: t(51), agent: "FORGE", kind: "stage", label: "SCAFFOLD" },
      { ts: t(52), agent: "FORGE", kind: "stage", label: "CODE — writing app.html" },
    ],
    approval: null,
    result: null,
    cancelable: true,
  },
  {
    ...
    team: [],
    events: [
      { ts: t(60), agent: "WARROOM", kind: "spawn", label: "Assembling the war room" },
      { ts: t(62), agent: "WARROOM", kind: "done", label: "report ready" },
    ],
    approval: null,
    result: {
      kind: "warroom",
  ...
  },
  {
    ...
    team: [],
    events: [
      { ts: t(70), agent: "REAPER", kind: "spawn", label: "Sweeping recurring charges" },
      { ts: t(74), agent: "REAPER", kind: "done", label: "ledger ready — 6 subscriptions" },
    ],
    approval: null,
    result: {
      kind: "reaper",
